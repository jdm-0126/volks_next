  ...
  // const [ privacyModalShow, setPrivacyModalShow] = useState(false);
    ...
    return (
        <Container fluid className="bg-info px-0 mx-0">
          <Container  className="text-white px-2">
              <Row className="d-flex justify-content-center align-items-center">
                <Col lg={4} md={6} sm={12} xs={12} className='my-5 h-25 text-center'>
                    <img width="60%" src="https://res.cloudinary.com/jdm01263d/image/upload/v1616479462/volkslift_project/logo-Volks_-_white.png" alt="logo"/>
