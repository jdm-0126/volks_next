    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            ...
            <div className="container">
                <a className="navbar-brand js-scroll-trigger" href="#page-top"><img src="https://res.cloudinary.com/jdm01263d/image/upload/v1616479555/volkslift_project/logo-Volks_ps9rm9.png" alt="" /></a>
