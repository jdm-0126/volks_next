    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            ...
            <div className="container">
                ...
                <button className="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#page-top" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
                    Menu
