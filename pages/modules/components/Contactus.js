...
const ContactUs = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      axios({
        method: 'post',
        url: 'http://localhost:3000/api/inquiry',
        data: {
          firstName: firstName,
          lastName: lastName,
          email: email,
                  ...
                  <Col className="d-flex flex-column align-items-center justify-content-center">
                    ...
                    {/* <Form noValidate validated={validated} onSubmit={handleSubmit}> */}
                        ...
                        {/* <Form.Group>
                         ...
                         <div>
                          <input className="mx-2" type="checkbox" name="agreement" value={agreement} id="agree" onChange={checkboxHandler} />
                          <label htmlFor="agree">  I agree to <a onClick={handleShow}>terms and conditions</a></label> || 
                          <label htmlFor="agree">  <a onClick={handlePrivacy}> privacy policy</a></label>
                          <Terms
                            show={modalShow}
                        ...
                        <Button  onClick={btnHandler} id="addBtn" type="submit" className="btn-info">Submit</Button>
                      </Form>
                    </Col>
                </Row>
                </Container>
